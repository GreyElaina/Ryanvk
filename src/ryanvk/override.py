...
class OverridePerformEntity(Generic[P, R]):
    ...
    @overload
    def __get__(
        self, instance: BasePerform, owner: type[BasePerform]
    ) -> OverridePerformAgent[P, R]:
        ...
...
class OverridePerformAgent(Generic[P, R]):
    ...
    def __init__(
        self, perform_entity: OverridePerformEntity[P, R], instance: BasePerform
    ) -> None:
