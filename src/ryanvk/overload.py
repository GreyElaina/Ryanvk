...
class FnOverload:
    ...
    def get_params_layout(
        self, params: list[str], args: dict[str, Any]
    ) -> dict[str, Any]:
...
class NoneOverload(FnOverload):
    ...
    def get_params_layout(
        ...
        if self.default_factory is not None:
            return {
                param: args.get(param) or self.default_factory(param)
                for param in params
            }
    ...
    def get_entities(
        ...
        for arg_name, arg_value in args.items():
            if arg_value is None:
                ...
                sets.append(
                    self.bypassing.get_entities(
                        bypassing_collection[arg_name], {arg_name: arg_value}
                    )
                )
